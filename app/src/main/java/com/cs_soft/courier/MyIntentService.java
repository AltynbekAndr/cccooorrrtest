...
public class MyIntentService extends IntentService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("MyIntentServiceLOG",login);
        Log.e("MyIntentServicePAS",password);
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        alarmService.set(AlarmManager.ELAPSED_REALTIME, SystemClock.elapsedRealtime() + 4000, restartServicePI);
    }
